...
class UserApi extends Api{
     ...
     */
    public function register($username, $password, $email, $mobile = '',$pimg,$card,$remark,$lanmu){
        return $this->model->register($username, $password, $email, $mobile,$pimg,$card,$remark,$lanmu);
    }
     ...
     * @author huajie <banhuajie@163.com>
     */
    public function updateInfoNopassword($uid, $data){
    	if($this->model->updateUserFieldsNopassword($uid, $data) !== false){
    		$return['status'] = true;
    	}else{
    		$return['status'] = false;
    		$return['info'] = $this->model->getError();
