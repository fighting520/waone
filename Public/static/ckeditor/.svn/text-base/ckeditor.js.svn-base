...
(function() {
    ...
    window.CKEDITOR || (window.CKEDITOR = function() {
        ...
        f = {
            ...
            basePath: function() {
                ...
                } - 1 == e.indexOf(":/") && "//" != e.slice(0, 2) && (e = 0 === e.indexOf("/") ? location.href.match(/^.*?:\/\/[^\/]*/)[0] + e: location.href.match(/^[^\?]*\/(?:)/)[0] + e);
    ...
    CKEDITOR.event.prototype = function() {
        ...
        b.prototype = {
            getListenerIndex: function(a) {
                for (var e = 0,
                d = this.listeners; e < d.length; e++) if (d[e].fn == a) return e;
                return - 1
            }
        };
        return {
    ...
    CKEDITOR.dom = {}; (function() {
        ...
        CKEDITOR.tools = {
            ...
            indexOf: function(a, e) {
                if (typeof e == "function") for (var d = 0,
                b = a.length; d < b; d++) {
                    if (e(a[d])) return d
                } else {
            ...
            createClass: function(a) {
                ...
                if (d) {
                    e.prototype = this.prototypedCopy(d.prototype);
            ...
            normalizeCssText: function(a, e) {
                var d = [],
                b,
                c = CKEDITOR.tools.parseCssText(a, true, e);
            ...
            checkIfAnyArrayItemMatches: function(a, e) {
                for (var d = 0,
                b = a.length; d < b; ++d) if (a[d].match(e)) return true;
                return false
            },
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
        ...
        getIndex: function(a) {
            function f(a, e) {
                var b = e ? a.nextSibling: a.previousSibling;
        ...
        getPrevious: function(a) {
            var f = this.$,
            b;
            do b = (f = f.previousSibling) && f.nodeType != 10 && new CKEDITOR.dom.node(f);
            while (b && a && !a(b));
            return b
        },
        getNext: function(a) {
        ...
        getPosition: function(a) {
            ...
            for (var f = this.getAddress(), a = a.getAddress(), b = Math.min(f.length, a.length), c = 0; c <= b - 1; c++) if (f[c] != a[c]) {
        ...
        getAscendant: function(a, f) {
            ...
            if (typeof a == "function") {
                ...
                c = function(e) {
                    ...
                    return typeof a == "string" ? e == a: e in a
                }
            }
            for (; b;) {
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.document.prototype, {
        ...
        getElementsByTag: function(a, f) { ! (CKEDITOR.env.ie && document.documentMode <= 8) && f && (a = f + ":" + a);
    ...
    CKEDITOR.dom.element.clearMarkers = function(a, f, b) {
        ...
        function b(a) {
            for (var d = 0,
            b = 0,
            f = c[a].length; b < f; b++) d = d + (parseInt(this.getComputedStyle(c[a][b]) || 0, 10) || 0);
            return d
        }
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            removeStyle: function(a) {
                ...
                if (!b.removeProperty && (a == "border" || a == "margin" || a == "padding")) {
                    ...
                    for (var b = [], j = 0; j < c.length; j++) if (f) for (var g = 0; g < f.length; g++) b.push([a, c[j], f[g]].join("-"));
            ...
            copyAttributes: function(a, b) {
                ...
                f = 0; f < c.length; f++) {
                    ...
                    m;
                    if (! (g in b)) if (g == "checked" && (m = this.getAttribute(g))) a.setAttribute(g, m);
    ...
    !0, {
        ...
        function a(a, b) {
            ...
            if (this.current) d = this.current[p](false, l, h);
                ...
                if (a) d.type == CKEDITOR.NODE_ELEMENT && (d = f > 0 ? d.getChild(f - 1) : h(d, true) === false ? null: d.getPreviousSourceNode(true, l, h));
                else {
                    d = e;
            ...
            for (c = l; c < A.length; c++) {
                ...
                if (!i[c] || g.$.parentNode != i[c].$.parentNode) for (g = g.getPrevious(); g;) {
                    ...
                    if (b == 2) n.$.insertBefore(g.$.cloneNode(true), n.$.firstChild);
                        ...
                        g.remove();
                        b == 1 && n.$.insertBefore(g.$, n.$.firstChild)
                    }
                    g = j
                }
                n && (n = C)
        ...
        CKEDITOR.dom.range.prototype = {
            ...
            createBookmark2: function() {
                function a(c) {
                    ...
                    f = d;
                    var m = e;
                    f = f.type != CKEDITOR.NODE_ELEMENT || m === 0 || m == f.getChildCount() ? 0 : f.getChild(m - 1).type == CKEDITOR.NODE_TEXT && f.getChild(m).type == CKEDITOR.NODE_TEXT;
                    if (f) {
                        d = d.getChild(e - 1);
                        e = d.getLength()
                    }
            ...
            enlarge: function(a, b) {
                ...
                case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        for (; l;) {
                            ...
                            if (l.type == CKEDITOR.NODE_COMMENT) l = l.getPrevious();
                                ...
                                if (l.type == CKEDITOR.NODE_TEXT) {
                                    ...
                                    j = l.getText();
                                    if (d.test(j)) l = null;
                                    else for (var C = l.$.getElementsByTagName("*"), k = 0, F; F = C[k++];) if (!CKEDITOR.dtd.$removeEmpty[F.nodeName.toLowerCase()]) {
                                        l = null;
                                        break
                                    }
                                    l && (n = !!j.length)
                                } else l = null;
                                n && (r ? p ? h = o: o && this.setStartBefore(o) : r = true);
                                if (l) {
                                    n = l.getPrevious();
                                    if (!o && !n) {
                                        o = l;
                    ...
                    if (n.type == CKEDITOR.NODE_TEXT) if (CKEDITOR.tools.trim(n.substring(C)).length) r = true;
                    else {
                        r = !n.getLength();
                        if (C == n.getLength()) {
                ...
                case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                    ...
                    if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                        ...
                        if ((o = o.previous()) && o.type == CKEDITOR.NODE_ELEMENT && o.is("br")) break
                    }
                    o = this.clone();
                    o.collapse();
            ...
            shrink: function(a, b, c) {
                if (!this.collapsed) {
                    ...
                    g = 1,
                    o = 1;
                    if (e && e.type == CKEDITOR.NODE_TEXT) if (i) if (i >= e.getLength()) d.setStartAfter(e);
                    else {
                        d.setStartBefore(e);
                        g = 0
                    } else d.setStartBefore(e);
                    if (f && f.type == CKEDITOR.NODE_TEXT) if (h) if (h >= f.getLength()) d.setEndAfter(f);
                    else {
                        d.setEndAfter(f);
                        o = 0
                    ...
                    d.guard = function(b, d) {
                        if (l(b)) return true;
                        if (a == CKEDITOR.SHRINK_ELEMENT && b.type == CKEDITOR.NODE_TEXT || d && b.equals(p) || c === false && b.type == CKEDITOR.NODE_ELEMENT && b.isBlockBoundary() || b.type == CKEDITOR.NODE_ELEMENT && b.hasAttribute("contenteditable")) return false; ! d && b.type == CKEDITOR.NODE_ELEMENT && (p = b);
                        return true
                    };
            ...
            moveToElementEditablePosition: function(a, b) {
                ...
                for (var c = 0; a;) {
                    ...
                    e = c,
                    f = void 0;
                    d.type == CKEDITOR.NODE_ELEMENT && d.isEditable(false) && (f = d[b ? "getLast": "getFirst"](g)); ! e && !f && (f = d[b ? "getPrevious": "getNext"](g));
                    a = f
                }
                return !! c
            },
        ...
        a.prototype = {
            getNextParagraph: function(a) {
                ...
                for (this._.nextNode = null; i;) {
                    ...
                    l = 0;
                    if (o) i.type == CKEDITOR.NODE_TEXT && e.test(i.getText()) && (o = 0);
                    else {
                        var p = i.getName();
                ...
                if (!f) {
                    ...
                    f = new CKEDITOR.dom.elementPath(h.startContainer, h.root);
                    i = f.blockLimit;
                    A = {
                        div: 1,
                        th: 1,
                ...
                if (!this._.nextNode) this._.nextNode = s || f.equals(t) || !t ? null: this._getNextSourceNode(f, 1, t);
                return f
            },
            _getNextSourceNode: function(a, b, c) {
                ...
                for (var f = this.range.root,
                a = a.getNextSourceNode(b, null, e); ! d(a);) a = a.getNextSourceNode(b, null, e);
                return a
            }
        };
    ...
    CKEDITOR.config = {
        ...
        function a(a, b, c, d, e) {
            ...
            d = a.length; c < d; ++c) {
                ...
                if (f.elements === true || f.elements === null) e[p ? "unshift": "push"](f);
                    ...
                    i = f.elements;
                    delete f.elements;
                    for (C in i) if (b[C]) b[C][p ? "unshift": "push"](f);
                    else b[C] = [f]
                }
            }
        }
        ...
        function w(a, b, d, e) {
            ...
            if (e.doCallbacks && a.elementCallbacks) {
                a: for (var x = a.elementCallbacks,
                h = 0,
                n = x.length,
                v; h < n; ++h) if (v = x[h](b)) {
                    r = v;
            ...
            if (e.doFilter) {
                a: {
                    ...
                    if (!a && !r) a = null;
                        ...
                        if (a) {
                            q = 0;
                            for (z = a.length; q < z; ++q) f(a[q], b, v, n)
                        }
                        if (r) {
                            q = 0;
        ...
        function l(a, b, c) {
            var d = a.name;
            if (L.$empty[d] || !a.children.length) if (d == "hr" && b == "br") a.replaceWith(u());
            else {
                a.parent && c.push({
                    check: "it",
                    el: a.parent
        ...
        CKEDITOR.filter.prototype = {
            allow: function(b, c, e) {
                ...
                if (typeof b == "string") b = m(b);
                    ...
                    for (f = 0; f < b.length; ++f) p = this.allow(b[f], c, e);
                    return p
                }
            ...
            applyTo: function(a, b, c, d) {
                ...
                null, true);
                f.length && (x = true);
                for (var n, a = [], d = G[d || (this.editor ? this.editor.enterMode: CKEDITOR.ENTER_P)], q; c = f.pop();) c.type == CKEDITOR.NODE_ELEMENT ? l(c, d, a) : c.remove();
                for (; n = a.pop();) {
                    c = n.el;
                    if (c.parent) {
            ...
            addContentForms: function(a) {
                if (!this.disabled && a) {
                    ...
                    if (e) {
                        for (b = 0; b < a.length; ++b) d.push(n(a[b], e));
            ...
            check: function(a, b, c) {
                ...
                if (typeof a == "string") {
                    ...
                    if (e) d.attributes.style = CKEDITOR.tools.writeCssText(d.styles);
                    e = d
                } else {
                    d = a.getDefinition();
                    e = d.styles;
                ...
                b = l.length > 0 ? false: CKEDITOR.tools.objectCompare(e.attributes, i.attributes, true) ? true: false;
            ...
            transform: function(a, b) {
                if (typeof b == "string") a.name = b;
                    ...
                    for (f in e) if (f == "class") {
                        c = a.classes.join("|");
                        for (p = e[f].split(/\s+/); l = p.pop();) c.indexOf(l) == -1 && a.classes.push(l)
    ...
    CKEDITOR.keystrokeHandler = function(a) {
        ...
        CKEDITOR.lang = {
            ...
            load: function(a, f, b) {
                if (!a || !CKEDITOR.lang.languages[a]) a = this.detect(f, a);
                var c = this,
                f = function() {
        ...
        return {
            load: function(b, c, e, d) {
                ...
                if (k === 0) m(true);
                    ...
                    var y = function(a, b) { (b ? j: g).push(a);
                        if (--k <= 0) {
    ...
    CKEDITOR.event.implementOn(CKEDITOR.ui); (function() {
        ...
        function e(a, b, c) {
            if (b) {
                ...
                for (e in f) {
                    d = f[e]; (c || d.contextSensitive) && d.refresh(a, b)
                }
            }
        }
        function d(a) {
        ...
        function m(a) {
            ...
            function(c) {
                ...
                for (var i in c) {
                    ...
                    if (g && !a.lang[i]) {
                        g.split && (g = g.split(","));
                        if (CKEDITOR.tools.indexOf(g, a.langCode) >= 0) o = a.langCode;
                        else {
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            ...
            destroy: function(a) {
                this.fire("beforeDestroy"); ! a && y.call(this);
                this.editable(null);
                this.filter.destroy();
                delete this.filter;
    ...
    CKEDITOR.htmlParser = function() {
        ...
        CKEDITOR.htmlParser.prototype = {
            ...
            parse: function(b) {
                for (var c, e, d = 0,
                h; c = this._.htmlPartsRegex.exec(b);) {
                    e = c.index;
                    if (e > d) {
                        d = b.substring(d, e);
                        if (h) h.push(d);
                    ...
                    if (h) h.push(c[0]);
                        ...
                        if (!/="/.test(e)) {
                            ...
                            this.onTagOpen(e, k, c); ! h && CKEDITOR.dtd.$cdata[e] && (h = [])
                        }
    ...
    "use strict"; (function() {
        ...
        CKEDITOR.htmlParser.node.prototype = {
            ...
            getAscendant: function(a) {
                var f = typeof a == "function" ? a: typeof a == "string" ?
                function(b) {
                    return b.name == a
                }: function(b) {
                    return b.name in a
    ...
    CKEDITOR.htmlParser.fragment = function() {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml = function(d, h, k) {
            function j(a) {
                var b;
            ...
            function y(b, c, d) {
                ...
                if (b.previous === void 0) {
                    ...
                    m(b); (!a(b) || b.children.length) && c.add(b);
                    b.name == "pre" && (l = false);
                ...
                if (a(e)) i.push(e);
                    ...
                    if (d == "br") A.push(e);
                        ...
                        for (;;) {
                            ...
                            if (!e.isUnknown && !u.isUnknown && !m[d]) if (u.isOptionalClose) q.onTagClose(h);
                            else if (d in b && h in b) {
                                h = u.children; (h = h[h.length - 1]) && h.name == "li" || y(h = new CKEDITOR.htmlParser.element("li"), u); ! e.returnPoint && (e.returnPoint = u);
                                u = h
                            } else if (d in CKEDITOR.dtd.$listItem && !w(d, h)) q.onTagOpen(d == "li" ? "ul": "dl", {},
                            0, 1);
                            else if (h in f && !w(d, h)) { ! e.returnPoint && (e.returnPoint = u);
                                u = u.parent
                            } else {
        ...
        CKEDITOR.htmlParser.fragment.prototype = {
            ...
            forEach: function(a, b, c) {
                ...
                if (e !== false) for (var c = this.children,
                f = 0; f < c.length; f++) {
                    e = c[f];
    ...
    "use strict"; (function() {
        ...
        a.prototype = {
            ...
            findIndex: function(a) {
                ...
                e = c.length - 1; e >= 0 && a < c[e].priority;) e--;
                return e + 1
            },
            exec: function(a, c) {
            ...
            execOnName: function(a, c) {
                ...
                f = d.length,
                k; c && e < f; e++) {
                    k = d[e]; ! (a.nonEditable && !k.options.applyToAll || a.nestedEditable && k.options.excludeNestedEditable) && (c = c.replace(k.value[0], k.value[1]))
                }
                return c
            }
        }
                ...
                return function(f) {
                    if (f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if (l) for (v(l, 1) && i.push(l); l;) {
                            if (d(l) && (x = c(l)) && v(x)) if ((r = c(x)) && !d(r)) i.push(x);
                            else {
                                p(g).insertAfter(x);
                                x.remove()
                            }
                        ...
                        if (i = !a || (typeof e == "function" ? e(f) : e) !== false) if (!g && !CKEDITOR.env.needsBrFiller && f.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT) i = false;
                ...
                return function(b) {
                    if (b.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if ("data-cke-bogus" in f || "data-cke-eol" in f) delete f["data-cke-bogus"];
                            ...
                            var i = c(b); ! f && d(b.parent) ? h(b.parent, p(a)) : d(f) && (i && !d(i)) && p(a).insertBefore(f)
                        }
                    }
                }
            } (g);
        ...
        function t(a, b) {
            for (var c = [], d = b.config.protectedSource, e = b._.dataStore || (b._.dataStore = {
                id: 1
            }), f = /<\!--\{cke_temp(comment)?\}(\d*?)--\>/g, d = [/<script[\s\S]*?<\/script>/gi, /<noscript[\s\S]*?<\/noscript>/gi, /<meta[\s\S]*?\/?>/gi].concat(d), a = a.replace(/<\!--[\s\S]*?--\>/g,
            function(a) {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            ...
            filter: function(a, b) {
                ...
                for (j in f) {
                    ...
                    g && ((k = a.onAttribute(b, d, g, k)) === false ? delete f[g] : f[g] = k)
                }
            ...
            getFirst: function(b) {
                ...
                for (var e = 0,
                d = this.children.length; e < d; ++e) if (b(this.children[e])) return this.children[e];
                return null
            },
            getHtml: function() {
    ...
    CKEDITOR.replaceClass = "ckeditor"; (function() {
        function a(a, e, d, h) {
            ...
            function() {
                b(k);
                h == CKEDITOR.ELEMENT_MODE_REPLACE && (k.config.autoUpdateElement && a.$.form) && k._attachToForm();
                k.setMode(k.config.startupMode,
                function() {
                    k.resetDirty();
                    k.status = "ready";
    ...
    CKEDITOR.config.startupMode = "wysiwyg"; (function() {
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                insertElementIntoRange: function(a, b) {
                    ...
                    var r, n;
                    if (f) for (; (r = b.getCommonAncestor(0, 1)) && (n = CKEDITOR.dtd[r.getName()]) && (!n || !n[e]);) if (r.getName() in CKEDITOR.dtd.span) b.splitElement(r);
                ...
                setup: function() {
                    ...
                    function() {
                        var b = this.getData();
                        this.is("textarea") || a.config.ignoreEmptyParagraph !== false && (b = b.replace(y,
                        function(a, b) {
                            return b
                        }));
                        a.setData(b, null, 1)
                        ...
                        function(b) {
                            ...
                            if (c in l) {
                                ...
                                if (CKEDITOR.env.ie && CKEDITOR.env.version < 11 && (f = b.getSelectedElement()) || (f = d(b))) {
                                    ...
                                    a.fire("saveSnapshot");
                                    e = 1
                                } else if (h.collapsed) if ((o = g.block) && (j = o[c ? "getPrevious": "getNext"](s)) && j.type == CKEDITOR.NODE_ELEMENT && j.is("table") && h[c ? "checkStartOfBlock": "checkEndOfBlock"]()) {
                                    a.fire("saveSnapshot");
                                    ...
                                    a: {
                                        ...
                                        if (f) if (d[c ? "checkStartOfBlock": "checkEndOfBlock"]()) if (!d.moveToClosestEditablePosition(f, !c) || !d.collapsed) e = false;
                                            ...
                                            if ((d = d.startPath().block) && (!d || !d.contains(f))) {
                                                a.fire("saveSnapshot");
                                                var j; (j = (c ? d: f).getBogus()) && j.remove();
                                                e = a.getSelection();
                                                j = e.createBookmarks(); (c ? f: d).moveChildren(c ? d: f, false);
        ...
        var q = function() {
                ...
                for (var g = r[g.getName()], n = 0, j = c.getChildren(), m = j.count(), o = -1, C = -1, k = 0, q = e.contains(r.$list); n < m; ++n) {
                    ...
                    if (a(e)) {
                        ...
                        if (q && l in CKEDITOR.dtd.$list) h = h.concat(b(e, d));
                            ...
                            p = !!g[l];
                            if (l == "br" && e.data("cke-eol") && (!n || n == m - 1)) {
            ...
            return function(g, n, k) {
                ...
                if (!v.checkReadOnly()) {
                    ...
                    B = q.createBookmark(); (z = B.startNode.getPrevious(c)) && a(z) && e(z) && G.push(z); (z = B.startNode.getNext(c)) && a(z) && e(z) && G.push(z);
                    ...
                    if (B) {
                        ...
                        for (p(x, t); B < x.length; B++) {
                            ...
                            if (D) G = B > 0;
                                ...
                                D = t.startPath();
                                if (!E.isBlock && h(n.editor, D.block, D.blockLimit) && (Q = n.editor.activeEnterMode != CKEDITOR.ENTER_BR && n.editor.config.autoParagraph !== false ? n.editor.activeEnterMode == CKEDITOR.ENTER_DIV ? "div": "p": false)) {
                                    Q = y.createElement(Q);
                                    Q.appendBogus();
                                    t.insertNode(Q);
                                ...
                                if (E.lastNotAllowed && B < x.length - 1) { (S = w ? z: S) && t.setEndAt(S, CKEDITOR.POSITION_AFTER_START);
                                    q = 0
                                }
                                t.collapse()
                            }
                    ...
                    for (T = J.createBookmark(); H = n.zombies.pop();) if (H.getParent()) {
                        Q = J.clone();
        ...
        t = function() {
            ...
            return function(d) {
                ...
                if (f.is("table")) {
                    ...
                    f.is("tr") && (f = b(f, f.getParent().is("thead") ? "th": "td", h)); (e = f.getBogus()) && e.remove();
        ...
        function f() {
            ...
            if (!w) {
                b.call(this);
                w = CKEDITOR.tools.setTimeout(b, 200, this)
            }
        }
        function b() {
            w = null;
            ...
            function() {
                ...
                if (CKEDITOR.env.ie && !v) {
                    ...
                    if (e.$.compatMode != "BackCompat") {
                        if (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) i.on("mousedown",
                        function(a) {
                            function b(a) {
                                a = a.data.$;
                                if (d) {
                        ...
                        if (CKEDITOR.env.version > 7 && CKEDITOR.env.version < 11) i.on("mousedown",
                        function(a) {
                ...
                CKEDITOR.env.webkit && g.attachListener(e, "keydown",
                function(a) {
            ...
            getRanges: function() {
                ...
                function() {
                    ...
                    var b = function(b, c) {
                        ...
                        f, g, h = b.duplicate(), v = 0, l = e.length - 1, i = -1, j, x; v <= l;) {
                            i = Math.floor((v + l) / 2);
                            f = e[i];
                    ...
                    if (g) this.fake(g);
                        ...
                        if (A) {
                            ...
                            for (v = 0; v < a.length; v++) {
                                ...
                                if (g.collapsed && CKEDITOR.env.webkit && e(g)) {
                                    m = this.root;
                                    h(m, false);
    ...
    CKEDITOR.STYLE_OBJECT = 3; (function() {
            ...
            if (b.collapsed) {
                ...
                for (n.getPosition(o) == CKEDITOR.POSITION_FOLLOWING && (n = 0); n;) {
                    ...
                    if (n.equals(o)) {
                        ...
                        if (s && m && CKEDITOR.dtd.$block[r]) for (var y = n,
                        u = c(y), A = void 0, C = u.length, F = 0, y = C && new CKEDITOR.dom.range(y.getDocument()); F < C; ++F) {
                            var A = u[F],
                        ...
                        if (u) if ((u = n.getParent()) && ((u.getDtd() || CKEDITOR.dtd.span)[e] || h) && (!g.parentRule || g.parentRule(u))) {
                            if (!p && (!r || !CKEDITOR.dtd.$removeEmpty[r] || (n.getPosition(o) | K) == K)) {
                                p = b.clone();
                                p.setStartBefore(n)
                            }
                            r = n.type;
                            if (r == CKEDITOR.NODE_TEXT || s || r == CKEDITOR.NODE_ELEMENT && !n.getChildCount()) {
                                for (var r = n,
                                U; (j = !r.getNext(L)) && (U = r.getParent(), k[U.getName()]) && (U.getPosition(q) | I) == I && (!g.childRule || g.childRule(U));) r = U;
                                p.setEndAfter(r)
                            }
                        } else j = true;
                        else j = true;
                    ...
                    if (j && p && !p.collapsed) {
                        for (var j = i(this, d), s = j.hasAttributes(), t = p.getCommonAncestor(), r = {},
                        u = {},
                        A = {},
                        C = {},
                        N, R, X; j && t;) {
                            if (t.getName() == e) {
                                for (N in g.attributes) if (!C[N] && (X = t.getAttribute(R))) j.getAttribute(N) == X ? u[N] = 1 : C[N] = 1;
        ...
        function s(a, b) {
            ...
            q(a, e, r[a.getName()]);
            f && (this._.definition.alwaysRemoveElement ? t(a, 1) : !CKEDITOR.dtd.$block[a.getName()] || this._.enterMode == CKEDITOR.ENTER_BR && !a.hasAttributes() ? t(a) : a.renameNode(this._.enterMode == CKEDITOR.ENTER_P ? "p": "div"))
        }
        function w(a) {
        ...
        function u(a, b) {
            for (var c in a) a[c] = a[c].replace(C,
            function(a, c) {
                return b[c]
            })
        }
        ...
        CKEDITOR.style.prototype = {
            ...
            removeFromRange: function(a) {
                this.removeFromRange = this.type == CKEDITOR.STYLE_INLINE ? b: this.type == CKEDITOR.STYLE_BLOCK ? k: this.type == CKEDITOR.STYLE_OBJECT ? d: null;
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {
        ...
        function a(a, c, e) {
            ...
            c[e ? "endContainer": "startContainer"] = f;
            return c
        }
                    ...
                    getNextRange: function(f) {
                        ...
                        if (k && a.length > 1) {
                            ...
                            if (f) for (var g = 0; a[d + g + 1];) {
                                for (var m = k.document,
                                f = 0,
                                j = m.getById(e[g].endNode), m = m.getById(e[g + 1].startNode);;) {
...
*/
    ...
    CKEDITOR.config.coreStyles_superscript = {
                        ...
                        e = d.createBookmarks(), c = c.createIterator(), g, j = 0; g = c.getNextRange(1);) {
                            ...
                            k.evaluator = function(a) {
                                ...
                                if (! (d = !(a && a.type == CKEDITOR.NODE_ELEMENT))) {
                                    if (d = a.getName() in p) {
                                        if (! (c = !a.is(c))) c = a.getParent(),
                                        c = !(c && c.type == CKEDITOR.NODE_ELEMENT) || !a.getParent().is("blockquote");
                                        d = c && a.getPosition(l) & CKEDITOR.POSITION_FOLLOWING && (a.getPosition(m) & CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_CONTAINS) == CKEDITOR.POSITION_PRECEDING
                                    }
                                    d = !d
                                }
                                return ! d
        ...
        function v(b) {
            ...
            function l(a, d) {
                ...
                if (!c.getById("cke_pastebin")) {
                    ...
                    CKEDITOR.env.safari && k.setStyles(CKEDITOR.tools.cssVendorPrefix("user-select", "text")); (f = k.getParent().isReadOnly()) ? (k.setOpacity(0), k.setAttribute("contenteditable", !0)) : k.setStyle("ltr" == b.config.contentsLangDirection ? "left": "right", "-1000px");
        ...
        CKEDITOR.ui.button.prototype = {
            render: function(a, b) {
                ...
                } else if (g && (g = a.getCommand(g))) g.on("state",
                function() {
            ...
            if (!1 !== a.resize_enabled) {
                ...
                function(a) {
                    if ("bottom" == a.data.space) {
                        var e = "";
                        i && !m && (e = " cke_resizer_horizontal"); ! i && m && (e = " cke_resizer_vertical");
    ...
    CKEDITOR.plugins.add("richcombo", {
        ...
        function j(a, b, c, f, m, j, p, r) {
            for (var s = a.config,
            n = new CKEDITOR.style(p), i = m.split(";"), m = [], k = {},
            d = 0; d < i.length; d++) {
                var h = i[d];
                if (h) {
                    var h = h.split("/"),
                ...
                onRender: function() {
                    ...
                    function(b) {
                        for (var c = this.getValue(), b = b.data.path.elements, d = 0, f; d < b.length; d++) {
                            f = b[d];
                            for (var e in k) if (k[e].checkElementMatch(f, !0, a)) {
                                e != c && this.setValue(e);
                                return
                            }
                        }
    ...
    CKEDITOR.config.format_tags = "p;h3;h4;h5";
    ...
    CKEDITOR.config.image_removeLinkByEmptyURL = !0; (function() {
        ...
        function s(c) {
            function f(b) {
                ...
                for (var g = j.isIndent ? 1 : -1, a = e[0], e = e[e.length - 1], i = CKEDITOR.plugins.list.listToArray(b, n), l = i[e.getCustomData("listarray_index")].indent, a = a.getCustomData("listarray_index"); a <= e.getCustomData("listarray_index"); a++) if (i[a].indent += g, 0 < g) {
                    var h = i[a].parent;
                ...
                if (!j.isIndent) {
                    var f;
                    if ((f = b.getParent()) && f.is("li")) for (var g = e.listNode.getChildren(), o = [], k, a = g.count() - 1; 0 <= a; a--)(k = g.getItem(a)) && (k.is && k.is("li")) && o.push(k)
                }
                e && e.listNode.replace(b);
                if (o && o.length) for (a = 0; a < o.length; a++) {
                    for (k = b = o[a]; (k = k.getNext()) && k.is && k.getName() in m;) CKEDITOR.env.needsNbspFiller && !b.getFirst(t) && b.append(d.document.createText(" ")),
                    b.append(k);
                    b.insertAfter(f)
                }
            ...
            n = this.database,
            m = this.context,
            l = c.getSelection(), l = (l && l.getRanges()).createIterator(), d; d = l.getNextRange();) {
                for (var b = d.getCommonAncestor(); b && !(b.type == CKEDITOR.NODE_ELEMENT && m[b.getName()]);) b = b.getParent();
                ...
                function f(c) {
                    ...
                    function(f) {
                        if ("wysiwyg" == c.mode && f.data.keyCode == this.indentKey) {
                            ...
                            if (l && (!this.isIndent || !CKEDITOR.plugins.indentList.firstItemInPath(this.context, c.elementPath(), l))) c.execCommand(this.relatedGlobal),
                            f.cancel()
                        }
                    },
                    this);
    ...
    CKEDITOR.UI_MENUBUTTON = "menubutton"; (function() {
        ...
        function E(b, k, e) {
            ...
            for (var f = CKEDITOR.plugins.list.listToArray(k.root, e), g = [], i = 0; i < k.contents.length; i++) {
                var h = k.contents[i];
                if ((h = h.getAscendant("li", !0)) && !h.getCustomData("list_item_processed")) g.push(h),
                CKEDITOR.dom.element.setMarker(e, h, "list_item_processed", !0)
            }
            h = null;
            for (i = 0; i < g.length; i++) h = g[i].getCustomData("listarray_index"),
            f[h].indent = -1;
            for (i = h + 1; i < f.length; i++) if (f[i].indent > f[i - 1].indent + 1) {
                g = f[i - 1].indent + 1 - f[i].indent;
                for (h = f[i].indent; f[i] && f[i].indent >= h;) f[i].indent += g,
                i++;
                i--
            }
        ...
        function A(b, k, e, d) {
            for (var f, g; f = b[d ? "getLast": "getFirst"](F);)(g = f.getDirection(1)) !== k.getDirection(1) && f.setAttribute("dir", g),
            f.remove(),
            e ? f[d ? "insertBefore": "insertAfter"](e) : k.append(f, d)
        }
        function B(b) {
            function k(e) {
        ...
        function y(b, k, e) {
            ...
            i ? (i = i.getBogus()) && i.remove() : h && (i = h.getPrevious(q)) && v(i) && i.remove(); (i = d.getLast()) && (i.type == CKEDITOR.NODE_ELEMENT && i.is("br")) && i.remove(); (i = k.startContainer.getChild(k.startOffset)) ? d.insertBefore(i) : k.startContainer.append(d);
        ...
        CKEDITOR.plugins.list = {
            listToArray: function(b, k, e, d, f) {
                if (!r[b.getName()]) return [];
                d || (d = 0);
                e || (e = []);
                for (var g = 0,
                i = b.getChildCount(); g < i; g++) {
                    var h = b.getChild(g);
                    ...
                    if ("li" == h.$.nodeName.toLowerCase()) {
                        ...
                        e.push(c);
                        for (var a = 0,
                        m = h.getChildCount(), j; a < m; a++) j = h.getChild(a),
                        j.type == CKEDITOR.NODE_ELEMENT && r[j.getName()] ? CKEDITOR.plugins.list.listToArray(j, k, e, d + 1, c.grandparent) : c.contents.push(j)
                    }
                }
                return e
            },
            arrayToList: function(b, k, e, d, f) {
                ...
                for (var g, i = b[e].parent.getDocument(), h = new CKEDITOR.dom.documentFragment(i), c = null, a = e, m = Math.max(b[e].indent, 0), j = null, n, l, p = d == CKEDITOR.ENTER_P ? "p": "div";;) {
                    ...
                    if (o.indent == m) {
                        if (!c || b[a].parent.getName() != c.getName()) c = b[a].parent.clone(!1, 1),
                        f && c.setAttribute("dir", f),
                        h.append(c);
                        ...
                        a++
                    } else if (o.indent == Math.max(m, 0) + 1) o = b[a - 1].element.getDirection(1),
                    a = CKEDITOR.plugins.list.arrayToList(b, null, a, d, o != n ? n: null),
                    !j.getChildCount() && (CKEDITOR.env.needsNbspFiller && 7 >= i.$.documentMode) && j.append(i.createText(" ")),
                    j.append(a.listNode),
                    a = a.nextIndex;
                        ...
                        x = o.contents.length,
                        t;
                        for (g = 0; g < x; g++) if (s = o.contents[g], D(s) && 1 < x) w ? t = s.clone(1, 1) : j.append(s.clone(1, 1));
                        ...
                        n = j.$.nodeName.toLowerCase(); ("div" == n || "p" == n) && j.appendBogus();
                        h.append(j);
                        c = null;
                        a++
                    } else return null;
                ...
                if (k) for (b = h.getFirst(); b;) {
                    if (b.type == CKEDITOR.NODE_ELEMENT && (CKEDITOR.dom.element.clearMarkers(k, b), b.getName() in CKEDITOR.dtd.$listItem && (e = b, i = f = d = void 0, d = e.getDirection()))) {
        ...
        x.prototype = {
            exec: function(b) {
                ...
                if (this.state == CKEDITOR.TRISTATE_OFF) {
                    var f = b.editable();
                    if (f.getFirst(q)) {
                        var g = 1 == d.length && d[0]; (k = g && g.getEnclosedNode()) && (k.is && this.type == k.getName()) && this.setState(CKEDITOR.TRISTATE_ON)
                    } else k.enterMode == CKEDITOR.ENTER_BR ? f.appendBogus() : d[0].fixBlock(1, k.enterMode == CKEDITOR.ENTER_P ? "p": "div"),
                    e.selectRanges(d)
                }
                for (var k = e.createBookmarks(!0), f = [], i = {},
                d = d.createIterator(), h = 0; (g = d.getNextRange()) && ++h;) {
                    var c = g.getBoundaryNodes(),
                    a = c.startNode,
                    m = c.endNode;
                    a.type == CKEDITOR.NODE_ELEMENT && "td" == a.getName() && g.setStartAt(c.startNode, CKEDITOR.POSITION_AFTER_START);
                    m.type == CKEDITOR.NODE_ELEMENT && "td" == m.getName() && g.setEndAt(c.endNode, CKEDITOR.POSITION_BEFORE_END);
                    g = g.createIterator();
                    for (g.forceBrBreak = this.state == CKEDITOR.TRISTATE_OFF; c = g.getNextParagraph();) if (!c.getCustomData("list_block")) {
                        ...
                        for (var j = b.elementPath(c), a = j.elements, m = 0, j = j.blockLimit, n, l = a.length - 1; 0 <= l && (n = a[l]); l--) if (r[n.getName()] && j.contains(n)) {
                            j.removeCustomData("list_group_object_" + h); (a = n.getCustomData("list_group_object")) ? a.contents.push(c) : (a = {
                                root: n,
                                contents: [c]
                            },
                ...
                for (n = []; 0 < f.length;) if (a = f.shift(), this.state == CKEDITOR.TRISTATE_OFF) if (r[a.root.getName()]) {
                    ...
                    j = [];
                    for (c = 0; c < h.contents.length; c++) if (l = h.contents[c], (l = l.getAscendant("li", !0)) && !l.getCustomData("list_item_processed")) j.push(l),
                    CKEDITOR.dom.element.setMarker(a, l, "list_item_processed", !0);
                    ...
                    for (c = 0; c < j && (m = a.listNode.getChild(c)); c++) m.getName() == this.type && g.push(m);
                    ...
                    if (! (1 > h.length)) {
                        ...
                        g.push(l);
                        for (p = g = void 0; h.length;) g = h.shift(),
                        p = d.createElement("li"),
                        g.is("pre") || H.test(g.getName()) || "false" == g.getAttribute("contenteditable") ? g.appendTo(p) : (g.copyAttributes(p), a && g.getDirection() && (p.removeStyle("direction"), p.removeAttribute("dir")), g.moveChildren(p), g.remove()),
                        p.appendTo(l);
                        ...
                        if (f && f.collapsed) {
                            ...
                            if (i) {
                                ...
                                if ((a = g.contains(r)) && f.checkBoundaryOfElement(a, CKEDITOR.START) && (a = a.getParent()) && a.is("li") && (a = w(a))) {
                                    ...
                                    if ((a = c.previous()) && a.type == CKEDITOR.NODE_ELEMENT && (a.getName() in r || a.is("li"))) {
                                        if (!a.is("li")) {
    ...
    CKEDITOR.plugins.add("scayt", {
        ...
        init: function(a) {
            ...
            a.contextMenu && a.addMenuItems && (a.contextMenu.addListener(function() {
                ...
                if (d) {
                    ...
                    if (e = e ? e.getAttribute(d.getNodeAttribute()) : e) b = c.menuGenerator(a, e, c),
                    d.showBanner("." + a.contextMenu._.definition.panel.className.split(" ").join(" ."))
                }
                return b
        ...
        addMenuItems: function(a) {
            ...
            if (b && b.length) for (var e = 0; e < b.length; e++) a.addMenuGroup("scayt_" + b[e], e - 10);
            b = {
                scaytToggle: {
            ...
            a.plugins.wsc && (b.WSC = {
                ...
                onClick: function() {
                    ...
                    b = a.scayt,
                    c = a.elementMode == CKEDITOR.ELEMENT_MODE_INLINE ? a.container.getText() : a.document.getBody().getText(); (c = c.replace(/\s/g, "")) ? (b && (d.state[a.name] && b.setMarkupPaused) && b.setMarkupPaused(!0), a.lockSelection(), a.execCommand("checkspell")) : alert("Nothing to check!")
                }
            });
            a.addMenuItems(b)
        },
        bindEvents: function(a) {
            ...
            f = function() {
                var d = a.editable();
                d.attachListener(d, "focus",
                function() {
                    var d = CKEDITOR.plugins.scayt && CKEDITOR.plugins.scayt.state[a.name] && a.scayt,
                    c,
                    e;
                    if ((b || d) && a._.savedSelection) for (var d = a._.savedSelection.getSelectedElement(), d = !d && a._.savedSelection.getRanges(), i = 0; i < d.length; i++) e = d[i],
                    c = e.startContainer.getText().length,
            ...
            function(b) {
                ...
                } else if ("bold" === b.data.name || "italic" === b.data.name || "underline" === b.data.name || "strike" === b.data.name || "subscript" === b.data.name || "superscript" === b.data.name) if (c = a.scayt) c.removeMarkupInSelectionNode(),
                setTimeout(function() {
        ...
        buildSuggestionMenuItems: function(a, c) {
            ...
            } else d.no_scayt_suggest = CKEDITOR.TRISTATE_DISABLED,
    ...
    CKEDITOR.plugins.scayt = {
        ...
        createScayt: function(a) {
            ...
            function(a) {
                ...
                function(a) {
                    for (var b = {},
                    d = [], c = 0; c < a.suggestionList.length; c++) if (!b["word_" + a.suggestionList[c]]) {
        ...
        loadScaytLibrary: function(a, c) {
            var d = this;
            "undefined" === typeof window.SCAYT || "function" !== typeof window.SCAYT.CKSCAYT ? (this.loadingHelper[a.name] = c, this.loadingHelper.loadOrder.push(a.name), CKEDITOR.scriptLoader.load(a.config.scayt_srcUrl,
            function() {
                var a;
