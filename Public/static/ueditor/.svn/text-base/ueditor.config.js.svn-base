...
(function () {
    ...
    //    , toolbars: [["fontfamily","fontsize","bold","italic","underline","forecolor","emotion",'simpleupload',"justifyleft","justifycenter","justifyright","simpleupload","spechars","blockquote","fullscreen","source","undo","redo",]]
